...
// [SIERRA-REMOVE] - RECORDS ACCESS - (гитхаб жалуется, перемещено в mods/utility_items/code/crew_record.dm)
...
// [SIERRA-REMOVE] - RECORDS ACCESS - (перемещено в mods/utility_items/code/crew_record.dm)
// #undef GETTER_SETTER
// #undef SETUP_FIELD
// #undef FIELD_SHORT
// #undef FIELD_LONG
