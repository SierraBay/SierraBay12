...
/obj/aura/mechshield/added_to(mob/living/target)
	...
	set_dir()
	register_signal(user, SIGNAL_DIR_SET, /obj/aura/mechshield/proc/update_dir)
...
/obj/aura/mechshield/Destroy()
	if(user)
		unregister_signal(user, SIGNAL_DIR_SET, /obj/aura/mechshield/proc/update_dir)
...
/obj/aura/mech_ballistic/added_to(mob/living/target)
	...
	target.vis_contents += src
	set_dir()
	register_signal(user, SIGNAL_DIR_SET, /obj/aura/mech_ballistic/proc/update_dir)
...
/obj/aura/mech_ballistic/Destroy()
	if (user)
		unregister_signal(user, SIGNAL_DIR_SET, /obj/aura/mech_ballistic/proc/update_dir)
		user.vis_contents -= src
	shield = null
	. = ..()
