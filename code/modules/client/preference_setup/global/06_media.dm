...
/datum/category_item/player_setup_item/player_global/media/load_preferences(datum/pref_record_reader/R)
	pref.media_volume = R.read("media_volume")
	pref.media_player = R.read("media_player")

/datum/category_item/player_setup_item/player_global/media/save_preferences(datum/pref_record_writer/W)
	W.write("media_volume", pref.media_volume)
	W.write("media_player", pref.media_player)
