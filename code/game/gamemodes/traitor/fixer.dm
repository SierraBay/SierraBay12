...
/datum/contract_fixer
	var/name = "The Nyx Fixer Operating System"
	...
	var/time_to_nex_contract = 10 MINUTES
...
/datum/contract_fixer/proc/roundstart()
	if(enable_roundstart_proc)
		...
		addtimer(new Callback(src, .proc/contract_tick), time_to_nex_contract)
...
/datum/admins/proc/edit_contracts()
	...
	var/out = "<meta charset=\"utf-8\"><b>The Fixer Jobs Menu</b>"
...
/datum/contract_organization/syndicate/ust
	name = "United Space Travelers"
	intents = CONTRACT_IMPACT_OPERATION | CONTRACT_IMPACT_MILITARY
/datum/contract_organization/syndicate/gm
	name = "Gorlex Marauders"
	intents = CONTRACT_IMPACT_MILITARY | CONTRACT_IMPACT_HIJACK
/datum/contract_organization/syndicate/vs
	name = "Void Star"
	intents = CONTRACT_IMPACT_SOCIAL
/datum/contract_organization/syndicate/th
	name = "Two Hands"
	intents = CONTRACT_IMPACT_SOCIAL | CONTRACT_IMPACT_OPERATION | CONTRACT_IMPACT_MILITARY
/datum/contract_organization/syndicate/rk
	name = "Redknight"
	intents = CONTRACT_IMPACT_SOCIAL | CONTRACT_IMPACT_OPERATION
/datum/contract_organization/syndicate/al
	name = "Aleph"
	intents = CONTRACT_IMPACT_SOCIAL | CONTRACT_IMPACT_HIJACK
/datum/contract_organization/syndicate/cj
	name = "Cyber Jacks"
	intents = CONTRACT_IMPACT_OPERATION | CONTRACT_IMPACT_MILITARY | CONTRACT_IMPACT_HIJACK
