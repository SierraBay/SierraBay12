...
#define SUIT_SENSOR_MODES list("Выключен" = SUIT_SENSOR_OFF, "Бинарный датчик" = SUIT_SENSOR_BINARY, "Трекер жизненно важных показателей" = SUIT_SENSOR_VITAL, "Маячёк слежения" = SUIT_SENSOR_TRACKING)
