...
/datum/job/vagabond/get_description_blurb()
	return "Безбилетник не является антагонистом и членом экипажа. Ваша задача дожить до конца раунда,\
	служба безопасности будет пытаться вас поймать, и в этом случае вы получите серьезное наказание.\
	Убивать офицеров СБ стоит только в крайних случаях, когда они по вам стреляют летальным оружием или зажали в угол.\
	Вы можете взламывать двери, перерезать провода в техах надев перчатки, тем самым открывая для себя нужные отделы и получая новые вещи, приборы, оружие, но не думайте, что никто это не заметит."
