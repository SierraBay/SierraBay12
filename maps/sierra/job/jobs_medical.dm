/datum/job/senior_doctor
	...
	alt_titles = list(
		...
		"Physician" = /singleton/hierarchy/outfit/job/sierra/crew/medical/doctor
	)
...
/datum/job/doctor
	...
	alt_titles = list()
	outfit_type = /singleton/hierarchy/outfit/job/sierra/crew/medical/doctor/paramedic
	allowed_branches = list(
		/datum/mil_branch/employee,
		/datum/mil_branch/contractor
	)
...
/datum/job/doctor/get_description_blurb()
	return "В отличии от хирургов парамедик занимается доставкой пациентов и лечением обычных ранений и травм. Обычно они не имеют высшего медицинского образования, но они всё равно являются опорой медбея."
