...
/datum/gear/accessory/solgov_patch
	display_name = "\improper SCGEC Observatory patch"
...
/datum/gear/accessory/solgov_patch/fieldops
	display_name = "\improper SCGEC Field Operations patch"
	path = /obj/item/clothing/accessory/solgov/ec_patch/fieldops
