...
/datum/technology/robo/mech_weapons
	...
	unlocks_designs = list("mech_ion","mech_laser","mech_flamer","mech_taser","mech_software_weapons","mech_SMG","SMG_ammo","mech_shield","mech_GRAD", "mech_GRAD_peper", "mech_GRAD_flashbang")
