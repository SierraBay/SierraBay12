/datum/technology/robo
	...
	unlocks_designs = list("robot_scanner", "paicard", "sflash","robot_exoskeleton","robot_exoskeleton_hover","robot_torso","robot_head","robot_l_arm","robot_r_arm","robot_l_leg","robot_r_leg","binary_communication_device","radio","actuator","diagnosis_unit","camera","armour","light_armour")
...
/datum/technology/robo/basic_mech
	...
	unlocks_designs = list("mech_software_engineering","mech_software_utility","treads","mech_frame", "mech_armour_basic", "mech_control_module", "powerloader_head", "powerloader_body", "powerloader_arms", "powerloader_legs", "quad_legs", "sphere_body" )
...
/datum/technology/robo/adv_mechs
	...
	unlocks_designs = list("heavy_legs", "heavy_arms","heavy_body","heavy_head","light_legs","light_arms","light_body","light_head","combat_legs","combat_arms","combat_body","mech_armour_combat", "mech_armour_em","mech_armour_radproof")
...
/datum/technology/robo/mech_equipment
	...
	unlocks_designs = list("hydraulic_clamp","gravity_catapult","mech_drill","mech_machete", "mech_floodlight","mech_camera","mech_flash")
...
/datum/technology/robo/adv_mech_tools
	...
	unlocks_designs = list("mech_shield","mech_rcd", "mech_shield_ballistic","mech_ionjets","mech_atmoshields","mech_plasma_auto")
...
/datum/technology/robo/mech_weapons
	...
	unlocks_designs = list("mech_ion","mech_laser","mech_flamer","mech_taser","mech_software_weapons")
...
/datum/technology/robo/roboupgrade
	...
	unlocks_designs = list("borg_rename_module","borg_reset_module","borg_floodlight_module","borg_restart_module","borg_vtec_module","borg_taser_module","borg_jetpack_module","borg_rcd_module","borg_flash_protection_module")
