...
/datum/design/item/weapon/nt41_smg
	...
	materials = list(MATERIAL_STEEL = 6000, MATERIAL_SILVER = 2000, MATERIAL_DIAMOND = 1000)
...
/datum/design/item/weapon/ion_pistol
	id = "ion_pistol"
	req_tech = list(TECH_COMBAT = 2, TECH_MAGNET = 4)
	materials = list(MATERIAL_STEEL = 3000, MATERIAL_GLASS = 500, MATERIAL_SILVER = 500)
...
/datum/design/item/weapon/assault_rifle
	...
	materials = list(MATERIAL_STEEL = 8000, MATERIAL_PLASTEEL = 3000, MATERIAL_SILVER = 2000)
...
/datum/design/item/weapon/sniper_rifle
	...
	materials = list(MATERIAL_STEEL = 8000, MATERIAL_GLASS = 2000, MATERIAL_DIAMOND = 2000, MATERIAL_URANIUM = 1000)
...
/datum/design/item/weapon/spatha_railgun
	...
	materials = list(MATERIAL_STEEL = 10000, MATERIAL_GOLD = 4000, MATERIAL_SILVER = 4000, MATERIAL_DIAMOND = 3000)
...
/datum/design/item/weapon/heltek_magnus
	...
	materials = list(MATERIAL_STEEL = 5000, MATERIAL_PLASTEEL = 2000)
...
/datum/design/item/weapon/heltek_mr735
	...
	materials = list(MATERIAL_STEEL = 7000, MATERIAL_PLASTEEL = 2000)
...
/datum/design/item/weapon/heltek_bonfire
	...
	materials = list(MATERIAL_STEEL = 6000, MATERIAL_GLASS = 2000, MATERIAL_SILVER = 1000, MATERIAL_PHORON = 500)
...
/datum/design/item/weapon/ftu_shotgun
	...
	materials = list(MATERIAL_STEEL = 5000, MATERIAL_PLASTEEL = 1000)
...
/datum/design/item/weapon/ftu_riot_shotgun
	id = "ftu_riot_shotgun"
	req_tech = list(TECH_COMBAT = 4, TECH_MATERIAL = 2)
	materials = list(MATERIAL_STEEL = 4000, MATERIAL_PLASTEEL = 1000)
