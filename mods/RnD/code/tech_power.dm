...
/datum/technology/power/fusion
	...
	unlocks_designs = list("fusion_core_control", "fusion_fuel_compressor", "fusion_fuel_control", "gyrotron_control", "gyrotron", "fusion_core", "fusion_injector", "fusion_kinetic_harvester")
