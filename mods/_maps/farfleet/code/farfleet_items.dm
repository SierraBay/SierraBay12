...
/obj/item/paper/farfleet/shield
	...
	<li>Выставь Радиус Щитов на 35 Единиц.</li>
...
/obj/item/paper/farfleet/reactor
	...
	<li>Выставь в Газовом Миксере с Южного порта максимальный пропуск и включить.</li>
	<li>Поставь на Южный порт канистру с водородом и прикрутить.</li>
...
/obj/item/paper/farfleet/engine
	...
	<ol>
	<li>Поставь на Западный порт Канистру с Кислородом и прикрути.</li>
	<li>Поставь на Восточный порт Канистру с Водородом и прикрути.</li>
...
/obj/item/paper/farfleet/shuttle
	...
	<p>На заправочной станции имеется 3 порта.<br />Фиолетовый это Водород.<br />Коричневый Это Углекислота.<br />Синий Это воздушная смесь.</p>
