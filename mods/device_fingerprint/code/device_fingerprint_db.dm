...
/client/proc/device_fingerprint_related_count(column, value)
	...
	switch(column)
		...
		if("browser_token_hash")
			safe_column = "browser_token_hash"
		else
			return 0
