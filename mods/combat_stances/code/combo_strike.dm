...
/decl/combo_strike/proc/strike_active(mob/user)
	if(strike_switch_text)
		to_chat(user,"<span class = 'danger'>[strike_switch_text]</span>")

/decl/combo_strike/proc/strike_invalid_target(mob/user, obj/item/striker)
...
/decl/combo_strike/proc/do_pre_strike(mob/user, atom/target, obj/item/striker, click_params)
	var/decl/combo_strike/strike_use = src
...
/decl/combo_strike/proc/do_strike_targ(mob/user, mob/living/m, obj/item/striker, click_params)
	m.use_weapon(striker, user, click_params)
	if(stamina_cost)
		user.adjust_stamina(-stamina_cost)

/decl/combo_strike/proc/do_strike(mob/user, atom/target, obj/item/striker, click_params)

/decl/combo_strike/proc/post_strike(mob/user, atom/target, obj/item/striker, click_params)
	if(next_strike)
		var/decl/combo_strike/strike = create_new_strike(user,striker,next_strike)
		strike.strike_active(user)

/decl/combo_strike/proc/create_new_strike(mob/user, obj/item/striker, new_path)
	var/decl/combo_strike/new_strike = new new_path ()
...
/decl/combo_strike/precise_strike/do_strike(mob/user, turf/target, obj/item/striker, click_params)
...
/decl/combo_strike/swipe_strike/do_strike(mob/user, turf/target, obj/item/striker, click_params)
	if(user.get_stamina() < stamina_cost)
		to_chat(user, SPAN_WARNING("Вы слишком устали!"))
		return FALSE
...
/decl/combo_strike/circle_strike/do_strike(mob/user, turf/target, obj/item/striker, click_params)
	if(user.get_stamina() < stamina_cost)
		to_chat(user, SPAN_WARNING("Вы слишком устали!"))
		return FALSE
	var/list/targets = list()
...
/decl/combo_strike/circle_strike/do_strike_targ(mob/user, mob/living/m, obj/item/striker, click_params)
	m.use_weapon(striker, user, click_params)
...
/decl/combo_strike/blunt_strike/do_strike(mob/user, turf/target, obj/item/striker, click_params)
	if(user.get_stamina() < stamina_cost)
		to_chat(user, SPAN_WARNING("Вы слишком устали!"))
		return FALSE
	if(istype(target))
...
/decl/combo_strike/blunt_strike/do_strike_targ(mob/user, mob/living/m, obj/item/striker, click_params)
...
/decl/combo_strike/precise_strike/fast_attacks
	...
	next_strike = /decl/combo_strike/precise_strike/fast_attacks/c1
	chain_base_strike = /decl/combo_strike/precise_strike/fast_attacks
	stamina_cost = 5

/decl/combo_strike/precise_strike/fast_attacks/c1
	strike_switch_text = null
	next_strike = /decl/combo_strike/precise_strike/fast_attacks/c2

/decl/combo_strike/precise_strike/fast_attacks/c2
	strike_switch_text = null
	...
	next_strike = /decl/combo_strike/precise_strike/fast_attacks/finalone

/decl/combo_strike/precise_strike/fast_attacks/finalone
	...
	next_strike = /decl/combo_strike/precise_strike/fast_attacks
	stamina_cost = 10

//Один взмах

/decl/combo_strike/swipe_strike/harrying_strike
	strike_dmg = STRIKE_MULT_DMG_LIGHT
	strike_speed = STRIKE_MULT_SPEED_MEDIUM
...
/decl/combo_strike/swipe_strike/mixed_combo
	strike_dmg = STRIKE_MULT_DMG_LIGHT
	...
	next_strike = /decl/combo_strike/precise_strike/mixed_combo
	chain_base_strike = /decl/combo_strike/swipe_strike/mixed_combo
	stamina_cost = 15

/decl/combo_strike/precise_strike/mixed_combo
	strike_dmg = STRIKE_MULT_DMG_STANDARD
	strike_speed = STRIKE_MULT_SPEED_MEDIUM
	strike_verbs = list("hewed","chopped")
	strike_switch_text = null
	next_strike = /decl/combo_strike/precise_strike/mixed_combo/c1
	chain_base_strike = /decl/combo_strike/swipe_strike/mixed_combo
	stamina_cost = 10

/decl/combo_strike/precise_strike/mixed_combo/c1
	next_strike = /decl/combo_strike/swipe_strike/mixed_combo

//Два тяжёлых удара

/decl/combo_strike/swipe_strike/sword_slashes
	...
	next_strike = /decl/combo_strike/swipe_strike/sword_slashes/slow
	chain_base_strike = /decl/combo_strike/swipe_strike/sword_slashes
	stamina_cost = 15

/decl/combo_strike/swipe_strike/sword_slashes/slow
	strike_dmg = STRIKE_MULT_DMG_STANDARD
	strike_speed = STRIKE_MULT_SPEED_SUPERSLOW
	strike_verbs = list("shallowly slashed","shallowly cut")
	strike_switch_text = null
	next_strike = /decl/combo_strike/swipe_strike/sword_slashes
	chain_base_strike = /decl/combo_strike/swipe_strike/sword_slashes
	stamina_cost = 15
...
/decl/combo_strike/swipe_strike/polearm_mixed
	strike_dmg = STRIKE_MULT_DMG_STANDARD
	strike_speed = STRIKE_MULT_SPEED_SLOW
	...
	next_strike = /decl/combo_strike/precise_strike/polearm_mixed
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_mixed
	stamina_cost = 15

/decl/combo_strike/precise_strike/polearm_mixed
	strike_dmg = STRIKE_MULT_DMG_STANDARD
	strike_speed = STRIKE_MULT_SPEED_STANDARD
	strike_verbs = list("stabbed","impaled")
	strike_range = 2
	strike_switch_text = null
	next_strike = /decl/combo_strike/precise_strike/polearm_mixed/c1
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_mixed
	stamina_cost = 10

/decl/combo_strike/precise_strike/polearm_mixed/c1
	strike_dmg = STRIKE_MULT_DMG_LIGHT
	strike_speed = STRIKE_MULT_SPEED_MEDIUM
	strike_verbs = list("grazingly stabbed","grazingly jabbed")
	strike_switch_text = null
	next_strike = /decl/combo_strike/swipe_strike/polearm_mixed/finale
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_mixed

/decl/combo_strike/swipe_strike/polearm_mixed/finale
	strike_dmg = STRIKE_MULT_DMG_SUPERHEAVY
	strike_speed = STRIKE_MULT_SPEED_SLOW
	strike_verbs = list("slashed","cut","lacerated")
	strike_switch_text = null
	next_strike = /decl/combo_strike/swipe_strike/polearm_mixed
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_mixed
	stamina_cost = 20

//Круговые замахи

/decl/combo_strike/swipe_strike/polearm_slash
	strike_dmg = STRIKE_MULT_DMG_STANDARD
	strike_speed = STRIKE_MULT_SPEED_SLOW
	strike_range = 2
	strike_verbs = list("slashed","cut","lacerated")
	strike_switch_text = "Вы размахиваете своим оружием во все стороны!"
	next_strike = /decl/combo_strike/swipe_strike/polearm_slash/slow
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_slash
	stamina_cost = 15

/decl/combo_strike/swipe_strike/polearm_slash/slow
	strike_dmg = STRIKE_MULT_DMG_STANDARD
	strike_speed = STRIKE_MULT_SPEED_SUPERSLOW
	strike_verbs = list("slashed","cut","lacerated")
	strike_switch_text = null
	next_strike = /decl/combo_strike/swipe_strike/polearm_slash
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_slash
	stamina_cost = 15

//Разносим всё вокруг

/decl/combo_strike/swipe_strike/polearm_wide
	strike_dmg = STRIKE_MULT_DMG_STANDARD
	strike_speed = STRIKE_MULT_SPEED_SUPERSLOW
	strike_verbs = list("slashed","cut","lacerated")
	strike_switch_text = "Вы приготовились к совершению медленной круговой атаки..."
	next_strike = /decl/combo_strike/circle_strike/polearm
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_wide
	stamina_cost = 10

/decl/combo_strike/circle_strike/polearm
	strike_dmg = STRIKE_MULT_DMG_SUPERHEAVY
	strike_speed = STRIKE_MULT_SPEED_SLOW
	strike_verbs = list("smashed","crushed","whacked")
	strike_switch_text = "Вы размахиваете своим оружием во все стороны!"
	stamina_cost = 30
	next_strike = /decl/combo_strike/swipe_strike/polearm_wide
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_wide
...
/decl/combo_strike/swipe_strike/polearm_mixed/hammer
	strike_verbs = list("smashed","crushed","whacked")
	next_strike = /decl/combo_strike/precise_strike/polearm_mixed/hammer
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_mixed/hammer

/decl/combo_strike/precise_strike/polearm_mixed/hammer
	strike_verbs = list("jabbed","poked")
	next_strike = /decl/combo_strike/precise_strike/polearm_mixed/c1/hammer
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_mixed/hammer

/decl/combo_strike/precise_strike/polearm_mixed/c1/hammer
	strike_verbs = list("grazingly jabbed","grazingly poked")
	next_strike = /decl/combo_strike/swipe_strike/polearm_mixed/finale/hammer
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_mixed/hammer

/decl/combo_strike/swipe_strike/polearm_mixed/finale/hammer
	strike_verbs = list("smashed","crushed","whacked")
	next_strike = /decl/combo_strike/swipe_strike/polearm_mixed/hammer
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_mixed/hammer

//Размашистые удары

/decl/combo_strike/swipe_strike/polearm_slash/hammer
	strike_verbs = list("smashed","crushed","whacked")
	next_strike = /decl/combo_strike/swipe_strike/polearm_slash/slow/hammer
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_slash/hammer

/decl/combo_strike/swipe_strike/polearm_slash/slow/hammer
	strike_verbs = list("smashed","crushed","whacked")
	next_strike = /decl/combo_strike/swipe_strike/polearm_slash/hammer
	chain_base_strike = /decl/combo_strike/swipe_strike/polearm_slash/hammer
...
/decl/combo_strike/swipe_strike/blunt_swing/mixed_combo
	strike_dmg = STRIKE_MULT_DMG_LIGHT
	strike_speed = STRIKE_MULT_SPEED_MEDIUM
	strike_verbs = list("smashed","crushed","whacked")
	strike_switch_text = "Вы разминаетесь, готовясь к 'отбиванию мяча'..."
	next_strike = /decl/combo_strike/blunt_strike/mixed_combo
	chain_base_strike = /decl/combo_strike/swipe_strike/blunt_swing/mixed_combo
	stamina_cost = 5

/decl/combo_strike/blunt_strike/mixed_combo
	strike_dmg = STRIKE_MULT_DMG_HEAVY
	strike_speed = STRIKE_MULT_SPEED_SLOW
	strike_verbs = list("smashed","crushed","whacked")
	next_strike = /decl/combo_strike/swipe_strike/blunt_swing/mixed_combo
	chain_base_strike = /decl/combo_strike/swipe_strike/blunt_swing/mixed_combo
	stamina_cost = 25

//Разносим всё вокруг

/decl/combo_strike/swipe_strike/blunt_swing/wide
	strike_dmg = STRIKE_MULT_DMG_STANDARD
	strike_speed = STRIKE_MULT_SPEED_SUPERSLOW
	strike_verbs = list("smashed","crushed","whacked")
	strike_switch_text = "Вы размахиваете своим оружием, готовясь к тяжёлой круговой атаке..."
	next_strike = /decl/combo_strike/circle_strike/blunt
	chain_base_strike = /decl/combo_strike/swipe_strike/blunt_swing/wide
	stamina_cost = 10

/decl/combo_strike/circle_strike/blunt
	strike_dmg = STRIKE_MULT_DMG_STANDARD
	strike_speed = STRIKE_MULT_SPEED_SLOW
	strike_verbs = list("smashed","crushed","whacked")
	strike_switch_text = "Вы размахиваете своим оружием во все стороны!"
	stamina_cost = 30
	next_strike = /decl/combo_strike/swipe_strike/blunt_swing/wide
	chain_base_strike = /decl/combo_strike/swipe_strike/blunt_swing/wide
