/datum/species/mantid
	...
	icobase =                 'mods/_fd/ascent/icons/alate/body.dmi'
	deform =                  'mods/_fd/ascent/icons/alate/body.dmi'
	damage_overlays =         'mods/_fd/ascent/icons/alate/damage_mask.dmi'
	blood_mask =              'mods/_fd/ascent/icons/alate/blood_mask.dmi'
	organs_icon =             'mods/_fd/ascent/icons/organs.dmi'
...
/datum/species/mantid/gyne
	...
	genders =                 list(FEMALE)
	icobase =                 'mods/_fd/ascent/icons/gyne/body.dmi'
	deform =                  'mods/_fd/ascent/icons/gyne/body.dmi'
	icon_template =           'mods/_fd/ascent/icons/gyne/template.dmi'
	damage_overlays =         'mods/_fd/ascent/icons/gyne/damage_mask.dmi'
	blood_mask =              'mods/_fd/ascent/icons/gyne/blood_mask.dmi'
