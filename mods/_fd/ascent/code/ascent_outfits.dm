...
/obj/item/clothing/mask/gas/ascent
	...
	sprite_sheets = list(
		...
		SPECIES_MANTID_GYNE =  'mods/_fd/ascent/icons/alate/onmob/onmob_mask_alate.dmi',
		SPECIES_MANTID_ALATE = 'mods/_fd/ascent/icons/gyne/onmob/onmob_mask_gyne.dmi'
	)
...
/obj/item/clothing/under/ascent
	...
	sprite_sheets = list(
		SPECIES_MANTID_GYNE =  'mods/_fd/ascent/icons/gyne/onmob/onmob_under_gyne.dmi',
		SPECIES_MANTID_ALATE = 'mods/_fd/ascent/icons/alate/onmob/onmob_under_alate.dmi'
	)
...
/obj/item/clothing/suit/storage/ascent
	...
	sprite_sheets = list(
		SPECIES_MANTID_GYNE =    'mods/_fd/ascent/icons/gyne/onmob/onmob_belt_gyne.dmi',
		SPECIES_MANTID_ALATE =   'mods/_fd/ascent/icons/alate/onmob/onmob_belt_alate.dmi',
