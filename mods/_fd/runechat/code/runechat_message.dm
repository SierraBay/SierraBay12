...
/hook/startup/proc/runechat_images()
	var/image/radio_image = image('mods/_fd/runechat/icons/chaticons.dmi', icon_state = "radio")
	GLOB.runechat_image_cache["radio"] = radio_image

	var/image/emote_image = image('mods/_fd/runechat/icons/chaticons.dmi', icon_state = "emote")
...
/datum/chatmessage/proc/generate_image(text, atom/target, mob/owner, list/extra_classes, lifespan)
	...
	if (extra_classes.Find("virtual-speaker"))
		var/image/r_icon = image('mods/_fd/runechat/icons/chaticons.dmi', icon_state = "radio")
		text = "\icon[r_icon]&nbsp;" + text
	else if (extra_classes.Find("emote"))
		var/image/r_icon = image('mods/_fd/runechat/icons/chaticons.dmi', icon_state = "emote")
		text = "\icon[r_icon]&nbsp;" + text
