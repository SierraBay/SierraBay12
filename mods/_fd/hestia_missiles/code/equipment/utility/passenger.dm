...
/obj/item/missile_equipment/passenger/MouseDrop_T(mob/target, mob/user)
	if(!ismob(target))
		return
...
/obj/item/missile_equipment/passenger/relaymove(mob/user)
...
/obj/item/missile_equipment/passenger/on_missile_activated(obj/overmap/missile/P)
	P.set_enter_zs(TRUE)
	close_hatch()
