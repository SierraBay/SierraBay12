/obj/machinery/computer/ship/ship_weapon/disruptor
	...
	prefire_sound = 'mods/old_space_cannons/sounds/disruptor_charging.ogg'
	fire_delay = 4

	shake_camera_force = 0

	fire_sound = 'mods/old_space_cannons/sounds/disruptor_shoot.ogg'
	far_fire_sound = 'mods/old_space_cannons/sounds/disruptor_shoot.ogg'
