#define SOUNDS_CRYSTAL_METAL    list('mods/old_space_cannons/sounds/glassbreak1.ogg','mods/old_space_cannons/sounds/glassbreak2.ogg','mods/old_space_cannons/sounds/glassbreak3.ogg')
