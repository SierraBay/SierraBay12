...
/obj/item/clothing/gloves/anomaly_detector/gurza
	name = "Gurza"
	desc = "An incredibly homemade detector clearly designed by a talented engineer. It is capable of detecting static voltage and determining its direction and distance. Despite its homemade nature, it looks extremely reliable. Blue duct tape included."
	...
	//Устройство не лезет на кисть или корманы.
