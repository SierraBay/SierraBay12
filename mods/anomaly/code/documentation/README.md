...
## Сабсистема_аномалий
Подсистема аномалий - SSanom. Постоянно процессит артефакты и определённый инструментарий.
TODO: Перевести продолжительную работу аномалий на SSanom, а не таймеры
