...
/obj/machinery/computer/diseasesplicer/use_tool(obj/item/I, mob/living/user, list/click_params)
	. = ..()
	if(isScrewdriver(I))
		return ..(I,user)
...
/obj/machinery/computer/diseasesplicer/interface_interact(mob/user)
	ui_interact(user)
	return TRUE
...
/obj/machinery/computer/diseasesplicer/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1)
	...
	if (!ui)
		ui = new(user, src, ui_key, "mods-disease_splicer.tmpl", src.name, 400, 600)
