...
/obj/machinery/disease2/incubator/use_tool(obj/item/O, mob/living/user, list/click_params)
	. = ..()
...
/obj/machinery/disease2/incubator/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1)
	...
	if (!ui)
		ui = new(user, src, ui_key, "mods-dish_incubator.tmpl", src.name, 400, 600)
