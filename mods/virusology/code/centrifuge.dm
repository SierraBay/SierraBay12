/obj/machinery/computer/centrifuge
	...
	core_skill = SKILL_SCIENCE//SKILL_VIROLOGY

/obj/machinery/computer/centrifuge/use_tool(obj/item/O, mob/living/user, list/click_params)
	. = ..()
	if(isScrewdriver(O))
		return ..(O,user)
...
/obj/machinery/computer/centrifuge/interface_interact(mob/user)
	ui_interact(user)
	return TRUE
...
/obj/machinery/computer/centrifuge/ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1)
	...
	if (!ui)
		ui = new(user, src, ui_key, "mods-isolation_centrifuge.tmpl", src.name, 400, 500)
