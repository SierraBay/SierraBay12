...
/turf/simulated/mineral/ice
	name = "Ice wall"
	icon_state = "ice_wall"
	icon = 'mods/new_planets/icons/clouds.dmi'
	color = COLOR_WHITE
	blocks_air = FALSE
...
/area/exoplanet/ice
	ambience = list('sound/effects/wind/tundra0.ogg','sound/effects/wind/tundra1.ogg','mods/new_planets/sounds/electra_planet_wind_2.ogg')
...
/obj/structure/ice_rock
	...
	icon = 'mods/new_planets/icons/icerocks.dmi'
	icon_state = "rock_1"
	anchored = TRUE
	density = TRUE
