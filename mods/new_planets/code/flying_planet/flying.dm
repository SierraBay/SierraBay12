...
/obj/overmap/visitable/sector/exoplanet/flying/build_level()
	...
	change_z_skybox.setup('mods/new_planets/icons/planet_backgrounds.dmi', "mods/anomaly/sounds/gravi_planet_wind_1.ogg")
...
/area/exoplanet/flying
	ambience = list('sound/effects/wind/tundra0.ogg','mods/new_planets/sounds/gravi_planet_wind_1.ogg')
