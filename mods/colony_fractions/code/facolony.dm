...
/obj/item/paper/sticky/facolony/emgexitnote
	...
	language = "Spacer"
	info = {"
	<b>ВНИМАНИЕ</b><br>Эти ворота ведут прямо на улицу.<br>Открывать <b>только в крайнем случае</b>.<br><br>Если задуматься, или просто посмотреть, они выглядят как вход.<br>Недруги будут думать о <b>них</b>, а не о скрытых проходах.<br><i>Я в этом уверен.</i>
	"}
