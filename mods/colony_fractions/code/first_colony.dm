...
/obj/item/paper/colony_ind
	...
	info = "<h1>Отчёт принят</h1><p>Ваш отчёт об успешной высадке на планету и развёртывании аванпоста успешно получен. В связи с этим, миссия должна приступить к следующему этапу включающие в себя: <BR>Разведка прилегающей к аванпосту местности<BR>Добыча ресурсов для дальнейшего строительства<BR>Расширение аванпоста и его подготовка к прибытию основной колонии<BR>Производство снаряжения и оборудования, которое может помочь миссии в дальнейшем."
