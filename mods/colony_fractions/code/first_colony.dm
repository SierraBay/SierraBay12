...
/obj/item/paper/colony_nt
	...
	info = "<h1>Отчёт принят</h1><p>Ваш отчёт об успешной высадке на планету и развёртывании аванпоста успешно получен. В связи с этим, миссия должна приступить к следующему этапу включающие в себя: <BR>Разведка прилегающей к аванпосту местности<BR>Добыча ресурсов для дальнейшего строительства<BR>Расширение аванпоста и его подготовка к прибытию основной колонии<BR>Производство снаряжения и оборудования, которое может помочь миссии в дальнейшем. <BR></B>Дополнительно сообщаем вам о прибытии исследовательного научного судна Сьерра в сектор. Способствуйте работу обьекта на планете в случае необходимости, сотрудничайте и помогайте обьекту в случае необходимости, не в вред своей освовной задаче.</p>"

/obj/item/paper/colony_gkk
	name = "Instructions for ICCG colony."
	info = "<h1>Отчёт принят</h1><p>Ваш отчёт об успешной высадке на планету и развёртывании аванпоста успешно получен. В связи с этим, миссия должна приступить к следующему этапу включающие в себя: <BR>Разведка прилегающей к аванпосту местности<BR>Добыча ресурсов для дальнейшего строительства<BR>Расширение аванпоста и его подготовка к прибытию основной колонии<BR>Производство снаряжения и оборудования, которое может помочь миссии в дальнейшем. <BR></B>В случае необходимости, вы можете запросить помощи у патрульного судна разведывательного судна ГКК. Согласно нашим данным, ваш сектор находится на пути их следования.</p>"

/obj/item/paper/colony_sol
	name = "Instructions for sol colony."
	info = "<h1>Отчёт принят</h1><p>Ваш отчёт об успешной высадке на планету и развёртывании аванпоста успешно получен. В связи с этим, миссия должна приступить к следующему этапу включающие в себя: <BR>Разведка прилегающей к аванпосту местности<BR>Добыча ресурсов для дальнейшего строительства<BR>Расширение аванпоста и его подготовка к прибытию основной колонии<BR>Производство снаряжения и оборудования, которое может помочь миссии в дальнейшем. <BR></B> В случае необходимости, вы можете запросить помощи у патрульного судна пятого флота. Согласно нашим данным, ваш сектор находится на пути их патрулирования.</p>"

/obj/item/paper/colony_ind
	name = "Instructions for colony."
	info = "<h1>Отчёт принят</h1><p>Ваш отчёт об успешной высадке на планету и развёртывании аванпоста успешно получен. В связи с этим, миссия должна приступить к следующему этапу включающие в себя: <BR>Разведка прилегающей к аванпосту местности<BR>Добыча ресурсов для дальнейшего строительства<BR>Расширение аванпоста и его подготовка к прибытию основной колонии<BR>Производство снаряжения и оборудования, которое может помочь миссии в дальнейшем.</p>"
