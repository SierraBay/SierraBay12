...
//
//
/obj/machinery/r_n_d/circuit_imprinter/colony
	req_access = list()
	base_type = /obj/machinery/r_n_d/circuit_imprinter/colony

/obj/item/stock_parts/circuitboard/circuit_imprinter/colony
	build_path = /obj/machinery/r_n_d/circuit_imprinter/colony
	req_components = list(
...
//
//
/obj/machinery/r_n_d/protolathe/colony
	req_access = list()
	base_type = /obj/machinery/r_n_d/protolathe/colony

/obj/item/stock_parts/circuitboard/protolathe/colony
	build_path = /obj/machinery/r_n_d/protolathe/colony
	req_components = list(
							/obj/item/stock_parts/matter_bin/super = 1,
							/obj/item/stock_parts/manipulator/pico = 2,
							/obj/item/stock_parts/micro_laser/ultra = 2,
...
//
//
/obj/machinery/r_n_d/destructive_analyzer/colony
	req_access = list()
	base_type = /obj/machinery/r_n_d/destructive_analyzer/colony

/obj/item/stock_parts/circuitboard/destructive_analyzer/colony
	build_path = /obj/machinery/r_n_d/destructive_analyzer/colony
	req_components = list(
...
/obj/machinery/robotics_fabricator/colony
	req_access = list()
	base_type = /obj/machinery/robotics_fabricator/colony

/obj/item/stock_parts/circuitboard/mechfab/colony
	build_path = /obj/machinery/robotics_fabricator/colony
	req_components = list(
		/obj/item/stock_parts/matter_bin/super = 1,
		/obj/item/stock_parts/manipulator/pico = 2,
		/obj/item/stock_parts/micro_laser/ultra = 2)
...
//
//
/obj/machinery/power/port_gen/pacman/super/potato/reactor/colony
	req_access = list()

/obj/item/stock_parts/circuitboard/pacman/super/potato/reactor/colony
	build_path = /obj/machinery/power/port_gen/pacman/super/potato/reactor/colony
	req_components = list(
		/obj/item/stock_parts/matter_bin/super = 1,
		/obj/item/stock_parts/micro_laser/ultra = 1,
		/obj/item/stock_parts/manipulator/pico = 1,
...
//
//
/obj/machinery/power/port_gen/pacman/mrs/colony
	req_access = list()
/obj/item/stock_parts/circuitboard/pacman/mrs/colony
	build_path = /obj/machinery/power/port_gen/pacman/mrs/colony
	req_components = list(
		/obj/item/stock_parts/matter_bin/super = 1,
		/obj/item/stock_parts/micro_laser/ultra = 1,
		/obj/item/stock_parts/manipulator/pico = 1,
...
//
//
/obj/machinery/mining/drill/colony
	req_access = list()
