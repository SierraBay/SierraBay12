...
/datum/map_template/ruin/exoplanet/playablecolony/proc/colony_inform()
	...
	if(GLOB.last_colony_type == "НАНОТРЕЙЗЕН")
		message += "<center><img src = ntlogo.png /><br />[FONT_LARGE("<b>NSV Sierra</b> Colony detected:")]<br> </center>"
		message += "<center>Сенсорами объекта ИСН Сьерра найдена колония принадлежавшей корпорации NanoTrasen. Далее будут стандартные протоколы с взаимодействием между объектом и колонии.</center>"
		message += "<center> ● Разрешены научные сделки на технологии или же обмен на артефактические структуры, Геологическая разведка планеты.</center>"
		message += "<center> ⊛ Разрешается любой обмен на интересующихся ресурс.</center>"
		message += "<center> ◍ Сотрудникам колонии одобрен проход на территорию объекта в случае чрезвычайное происшествия.</center>"
		message += "<center> Колония это актив корпорации Нанотрейзен, сделайте всё от себя зависящее не в вред основной миссии для помощи колонии.</center>"
