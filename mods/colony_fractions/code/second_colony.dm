...
/obj/item/paper/colony2_nt
	...
	info = "<h1>Отчёт принят</h1><p>Приняли информацию о успешном достижении цели полёта, приказываем начать высадку на планету. Ваши цели как авангарда основной колонии: <BR>Разведка прилегающей к судну местности<BR>Добыча ресурсов для дальнейшего строительства<BR>Строительство аванпоста и его подготовка к прибытию основной колонии<BR>Производство снаряжения и оборудования, которое может помочь миссии в дальнейшем. <BR>Дополнительно сообщаем вам о прибытии исследовательного научного судна Сьерра в сектор. Способствуйте работу обьекта на планете в случае необходимости, сотрудничайте и помогайте обьекту в случае необходимости, не в вред своей освовной задаче.</p>"

/obj/item/paper/colony2_gkk
	name = "Instructions for ICCG colony."
	info = "<h1>Отчёт принят</h1><p>Приняли информацию о успешном достижении цели полёта, приказываем начать высадку на планету. Ваши цели как авангарда основной колонии: <BR>Разведка прилегающей к судну местности<BR>Добыча ресурсов для дальнейшего строительства<BR>Строительство аванпоста и его подготовка к прибытию основной колонии<BR>Производство снаряжения и оборудования, которое может помочь миссии в дальнейшем. <BR>В случае необходимости, вы можете запросить помощи у патрульного судна разведывательного судна ГКК. Согласно нашим данным, ваш сектор находится на пути их следования.</p>"

/obj/item/paper/colony2_sol
	name = "Instructions for sol colony."
	info = "<h1>Отчёт принят</h1><p>Приняли информацию о успешном достижении цели полёта, приказываем начать высадку на планету. Ваши цели как авангарда основной колонии: <BR>Разведка прилегающей к судну местности<BR>Добыча ресурсов для дальнейшего строительства<BR>Строительство аванпоста и его подготовка к прибытию основной колонии<BR>Производство снаряжения и оборудования, которое может помочь миссии в дальнейшем. <BR>В случае необходимости, вы можете запросить помощи у патрульного судна пятого флота. Согласно нашим данным, ваш сектор находится на пути их патрулирования.</p>"
