/proc/animated_teleportation(atom/movable/target, atom/anchor)
	...
	var/obj/temporary/A = new(get_turf(target), 24.5, 'mods/_master_files/icons/effects/bs_silk.dmi', "silc_teleport_back")
	target.set_dir(2)
	target.forceMove(A)
...
/proc/animated_teleportation_ending(atom/movable/target, atom/anchor)
	target.set_dir(2)
	target.forceMove(new /obj/temporary(get_turf(anchor), 26.5, 'mods/_master_files/icons/effects/bs_silk.dmi', "silc_get_hub"))
