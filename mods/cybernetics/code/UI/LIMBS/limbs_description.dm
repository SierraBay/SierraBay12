...
/datum/category_item/player_setup_item/cybernetics/proc/draw_choosed_limb_desc(user, input_list)
	...
	if(limb_type == "Пусто")
		...
		if(pref.choosed_limb_prototype && pref.choosed_limb_prototype.aug_description_long)
	...
	input_list += {"
	<div class='limb-desc-container' style='position: absolute; left: 600px; top: 150px; width: 400px;'>
		[result_text]
	</div>
	"}
