...
/obj/machinery/computer/telecomms/traffic
	...
	desc = "Manipulates with traffic of a telecommunications network."
	icon_screen = "comm_monitor"
	machine_name = "telecomms traffic control console"
...
/obj/machinery/computer/telecomms/traffic/interface_interact(mob/user)
	interact(user)
	return TRUE
...
/obj/machinery/computer/telecomms/traffic/interact(mob/user)
	...
	//var/datum/browser/popup = new(user, "traffic_control", "Telecommunications Traffic Control", 575, 400)
...
/obj/machinery/computer/telecomms/traffic/OnTopic(mob/user, list/href_list, datum/topic_state/state)
	if(..())
		return
