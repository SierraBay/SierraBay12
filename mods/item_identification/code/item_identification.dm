...
/datum/extension/interactive/mod_inspect/proc/examine_item(mob/user, obj/item/I)
	...
	HTML += "<hr>"
	HTML += "Вместо этого вы можете <b>соглать</b> при инспекции предмета, тогда ваши навыки не будут задействованы для осмотра. Но при этом добавленные вами люди все еще могут задействовать свои навыки для инспекции.<br>"
