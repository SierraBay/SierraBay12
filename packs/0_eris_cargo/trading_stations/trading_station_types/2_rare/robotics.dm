/datum/trading_station/venus
	...
	inventory = list(
		...
		TRADE_CAT_EXOSUIT = list(
			...
			/mob/living/exosuit/premade/powerloader = CUSTOM_GOODS_NAME("Xion Industrial 'R15LE' powerloader"),
			/mob/living/exosuit/premade/light = CUSTOM_GOODS_NAME("Vey-Med 'E-58' light exosuit"),
			/obj/item/mech_equipment/sleeper = CUSTOM_GOODS_NAME("Vey-Med S-26' exosuit-mounted sleeper"),
			/obj/item/mech_equipment/ionjets = CUSTOM_GOODS_NAME("Xion Industrial 'EIJ160' exosuit ion jets"),
			/obj/item/mech_equipment/clamp = CUSTOM_GOODS_NAME("Xion Industrial 'ECC40' exosuit clamp"),
			/obj/item/mech_equipment/light = CUSTOM_GOODS_NAME("Grayson Manufactories '4/13' exosuit floodlight"),
			/obj/item/mech_equipment/mounted_system/taser/plasma = CUSTOM_GOODS_NAME("Grayson Manufactories '5/38' exosuit-mounted plasmacutter"),
			/obj/item/mech_equipment/mounted_system/taser/autoplasma = CUSTOM_GOODS_NAME("Xion Industrial 'ERP34' exosuit rotating plasmacutter"),
			/obj/item/mech_equipment/atmos_shields = CUSTOM_GOODS_NAME("Aether Atmospherics 'Zephyros' exosuit atmostheric shield"),
			/obj/item/mech_equipment/mounted_system/rcd = CUSTOM_GOODS_NAME("Xion Industrial 'LMB220' leg muscle booster implant"),
			/obj/item/mech_equipment/mounted_system/extinguisher = CUSTOM_GOODS_NAME("Grayson Manufactories '4/23' exosuit-mounted fire extinguisher"),
			/obj/item/mech_equipment/drill = CUSTOM_GOODS_NAME("Grayson Manufactories '5/18' exosuit-mounted mining drill"),
			/obj/item/material/drill_head/steel = CUSTOM_GOODS_NAME("Grayson Manufactories '5/08' mining drill head"),
			),
		TRADE_CAT_AUG = list(
