...
/proc/create_away_account(account_name = "Default account name", owner_name, starting_funds = 0, account_type = ACCOUNT_TYPE_PERSONAL, obj/machinery/computer/account_database/source_db)
...
/datum/job/proc/setup_away_account(mob/living/carbon/human/H)
